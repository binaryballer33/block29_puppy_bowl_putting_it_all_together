...
export const puppyBowlApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    getPlayers: builder.query({ query: () => '/api/2311-fsa-et-web-ft-sf/players' }),
    getPlayer: builder.query({ query: (id) => `/api/2311-fsa-et-web-ft-sf/players/${id}` }),
    createPlayer: builder.mutation({
      query: (newPlayer) => ({
        url: '/api/2311-fsa-et-web-ft-sf/players',
        method: 'POST',
        body: newPlayer,
      }),
    }),
...
console.log("Puppy Bowl API: ", puppyBowlApi);
console.log("Puppy Bowl API Endpoints: ", puppyBowlApi.endpoints);
console.log("Puppy Bowl API Reducer: ", puppyBowlApi.reducer);
